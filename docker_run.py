...
if __name__=="__main__":
    ...
    parser.add_argument("-c", "--container", type=str, default="ros-melodic-container", help="(optional) name of the container")\
    ...
    config_file = os.path.join(source_dir, 'docker_run_config.yaml')

    print(source_dir)

    image_name = args.image
    home_directory = '/home/' + user_name
    ws_moveit_source_dir = os.path.join(home_directory, 'ws_moveit')
    ...
    cmd += " -v /home/%(use_name)s/ws_moveit:%(home_directory)s/ws_moveit "  \
        % {'use_name': user_name, 'home_directory': home_directory}              # mount source
    ...
    cmd += "-v /home/whl/data:/home/whl/data"
    
    # expose UDP ports
    cmd += " -p 5901:5901 -p 6901:6901 "
    #cmd += " --ipc=host "
